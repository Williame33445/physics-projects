...
def nucInt1s(R_a,alpha_a,R_b,alpha_b,Rs,Zs):
    return sum([nucInt1sSingle(R_a,alpha_a,R_b,alpha_b,R,Zs[n]) for n,R in enumerate(Rs)])
...
def nucInt1sSingle(R_a,alpha_a,R_b,alpha_b,R_C,Z):
